...
dropdown_bar = dbc.Row(
    [
        dbc.Col(job_dropdown, style={"width":"70%"}),
        dbc.Col(html.Div(dd_sort_toggle, style = {"color":"white", "padding":"0px"}), style={"width":"30%"})
    ],
    no_gutters = True,
...
app.layout = html.Div(children=[
    ...
    [
        dbc.Row(
            [
                dbc.Col(
                    html.H2(children='Swiss Jobs (via LinkedIn)', style = {"color":"white"}), style={"width":"100%"}
                    ),
                # dbc.Col(
...
# app.layout = html.Div(children=[
#     dbc.Navbar([
#         html.H1(children='Swiss Jobs (via LinkedIn)'),
#         dbc.Col(job_dropdown)
#     ],sticky="top"), ###end navbar
#     html.Hr(),
#     dbc.Row([
#     job_title,
    
#     html.Div(children=[dcc.Link(html.Button("Go to LinkedIn page", id="button",style={"display":"none"}), id='job_url', href = "javascript:void(0);"), job_keywords],
#     style={
#                         "display": "inline-block",
#                         "width": "50%",
#                         "margin-right": "20px",
#                         "verticalAlign": "top"
#                     }),
#                     html.Hr()], style = {"position": "sticky", 'backgroundColor':'white', 'top':0}),#, "top": 0}),
#     html.Div(id="plot_div", children = init_plot),
#     job_desc_output
# ])

#************************** <LAST WORKING - V1 - BEST> *********************
# app.layout = html.Div(children=[
#     dbc.Navbar([
#         html.H1(children='Swiss Jobs (via LinkedIn)'),
#     #html.Div(children='''Div tag.'''),
#     #html.P(children="This is a paragraph test"),
#         dbc.Col(job_dropdown)
#     #html.Div(id="plot_div", children = init_plot),
#     ],sticky="top"), ###end navbar
#     html.Hr(),
...
# @app.callback(
#     Output('job_desc_output', 'children'),
#     Input('job_desc_area', 'value')
# )

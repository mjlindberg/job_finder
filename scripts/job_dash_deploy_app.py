        ...
        dbc.Row(
            [
                dbc.Col( #set H2 display to 'flex' to separate
                    html.H2(children='SWISS JOBS', style = {"color":"white", "fontStyle":"italic","fontWeight":800, "position":"relative","bottom":"5px"}), style={"width":"auto", "display":"inline-block", "box-sizing":"border-box", "clear":"both", "margin-left":"25px", "margin-right":"35px"}#, align="left"
                    ),
                dbc.Col(dbc.Collapse(dropdown_bar, navbar = True), style={"width":"69%", "display":"inline-block", "box-sizing":"border-box", "clear":"both", "verticalAlign": "center", "margin-right":"-5px", "padding":"0px"}),
                # dbc.Col(
...
def update_output(id, sort_toggle, logo_dict, total_jobs_badge):
    if id is None:
        ...
        return [""]*4 + [logo_dict, init_plot, total_jobs_badge]
        raise PreventUpdate
